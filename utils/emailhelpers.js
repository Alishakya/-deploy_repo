...
export const sendMail = async ({ email, name }) => {
  try {
    ...
    const transporter = nodemailer.createTransport({
      service: "gmail",
      auth: {
        user: "lupinghoul@gmail.com", // Replace with your email
        pass: "qpzp cghb hoqu aelb", // Replace with your app password
      },
    });

    // Define email options
    const mailOptions = {
      from: "lupinghoul@gmail.com", // Replace with your email
      to: email,
